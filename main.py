...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            MAIN_MENU: [
                CallbackQueryHandler(show_connect_wallet_button, pattern="^(validation|claim_tokens|assets_recovery|general_issues|rectification|withdrawals|login_issues|missing_balance|account_recovery|claim_spin|refund|claim_sticker_reward)$"),
